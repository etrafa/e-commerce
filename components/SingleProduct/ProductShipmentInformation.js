...
const ProductShipmentInformation = ({
  ...
  return (
    <div className="lg:ml-24">
      ...
      <div className="flex ml-4 items-center mt-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <Link href="/size-chart">
          <span className="text-border ml-2">Size Chart</span>
        </Link>
      </div>
      <hr className="w-11/12 mx-auto mt-4" />
      <div>
        <div className="flex ml-4 mt-4">
          ...
          <span className="pl-2 text-sm">
            Ship out within 1-3 business days
          </span>
        </div>
        <div className="flex ml-4 mt-4">
          <svg
...
export default ProductShipmentInformation;
